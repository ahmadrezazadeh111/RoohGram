...
public class ApplicationLoader extends Application {
    ...
    public boolean get_default() {
        SharedPreferences reader = ApplicationLoader.applicationContext.getSharedPreferences("def1", ApplicationLoader.applicationContext.MODE_PRIVATE);
        return reader.getBoolean("active", false);
    }

    public void set_def() {
        SharedPreferences.Editor edt = ApplicationLoader.applicationContext.getSharedPreferences("def1", ApplicationLoader.applicationContext.MODE_PRIVATE).edit();
